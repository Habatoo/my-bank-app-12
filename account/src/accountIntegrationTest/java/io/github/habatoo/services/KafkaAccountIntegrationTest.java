...
import io.github.habatoo.controllers.AccountController;
import io.github.habatoo.controllers.UserController;
...
@EmbeddedKafka(
        topics = {KafkaAccountIntegrationTest.TEST_TOPIC_NAME},
        partitions = 1,
        bootstrapServersProperty = "spring.kafka.bootstrap-servers"
)
@ActiveProfiles("test")
class KafkaAccountIntegrationTest {
